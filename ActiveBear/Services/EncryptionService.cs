...
namespace ActiveBear.Services
{
    ...
    public static class EncryptionService
    {
        ...
        {
            return AesEncrypt<AesManaged>(value, password);
        }

        public static string AesEncrypt<T>(string value, string password)
        ...
        public static string AesDecrypt(string value, string password)
        {
            return AesDecrypt<AesManaged>(value, password);
        }
